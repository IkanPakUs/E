					...
					<div class="card__footer">
						<div class="pagination">
							<div class="pagination__left">
								<i page="<?= $User->meta["page"] ?>" class="bi bi-chevron-left paginate_nav <?= $User->meta["page"] <= 1 ? "disable" : "" ?> prev"></i>
							</div>
							<div class="pagination__page-info">
								<ul>
									<?php for ($i=1; $i <= $User->meta["total"] ; $i++) : ?>
									<li page="<?= $i ?>" class="<?= $i == 1 ? "active" : "" ?> paginate_nav"><?= $i ?></li>
									<?php endfor ?>
								</ul>
							</div>
							<div class="pagination__right">
								<i page="<?= $User->meta["page"] ?>" class="bi bi-chevron-right paginate_nav  <?= $User->meta["page"] >= $User->meta["total"] ? "disable" : "" ?> next"></i>
							</div>
						</div>
					</div>
				</div> 
